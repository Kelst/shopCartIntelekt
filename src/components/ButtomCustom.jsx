...
export default function ButtomCustom({onClick,text,flag}) {
 ...
 {  
 flag? 
 <div onClick={onClick}  className=" max-w-[200px]  ml-auto mr-auto  cursor-pointer relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-medium transition-all bg-red-500 rounded-xl group">
